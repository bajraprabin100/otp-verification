...
import { OtpInput } from "src/app/shared/components/design-system/otp.component";
import { useMutation } from "@tanstack/react-query";
import {
  validateOtp
} from "@/app/core/services/api/auth/auth.service";
...
function SignUpStepTwoComponent() {
      ...
      <form
        ...
        <OtpInput
          ...
          TextFieldsProps={(index) => ({
            sx: {
              border: otp[index] !==undefined && isNaN(parseInt(otp[index])) ? '1px solid red' : '1px solid #ccc',
